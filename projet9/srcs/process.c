...
/*   Updated: 2019/05/06 15:16:14 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_env_update_object(t_env *e, t_menu *menu, float rev)
{
	...
	(*s)->rotate.x = ft_clamp(-179.0, 179.0, (*s)->rotate.x);
	(*s)->rotate.y = ft_clamp(-179.0, 179.0, (*s)->rotate.y);
	(*s)->rotate.z = ft_clamp(-179.0, 179.0, (*s)->rotate.z);
	return (1);
}
