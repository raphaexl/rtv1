...
/*   Updated: 2019/04/08 18:15:09 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	ft_rotate_vec3(t_vector r, t_vector v, int invert)
{
	if (invert)
	{
		r = ft_rotate_z(r, ft_degre_to_radian(-v.z));
		r = ft_rotate_y(r, ft_degre_to_radian(-v.y));
		r = ft_rotate_x(r, ft_degre_to_radian(-v.x));
	}
	else
	{
		r = ft_rotate_z(r, ft_degre_to_radian(v.z));
