...
/*   Updated: 2019/04/22 13:23:40 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_render(t_scene *s, Uint32 *pixels, t_menu *m)
{
	...
	while (++y < W_H)
	{
		...
		/*	inter.ray.start = ft_vector(x, y, -10000.0f);	
			inter.ray.dir = ft_vector(0, 0, 1.0);*/
			c = ft_ray_trace2(s, &inter, m);
			pixels[x + (W_H - 1 - y) * W_W] = ft_rgb_color((unsigned char)fmin(c.red * 255.0, 255.0), 
