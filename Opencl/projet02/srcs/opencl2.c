...
/*   Updated: 2019/05/10 19:16:54 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_opencl_kernel(t_opencl *opencl)
{
	...
	ret = clSetKernelArg(opencl->kernel, 0, sizeof(cl_mem), (void *)&opencl->pixels_mem_obj);
	ret = clSetKernelArg(opencl->kernel, 1, sizeof(t_scene), (void *)&opencl->scene);
