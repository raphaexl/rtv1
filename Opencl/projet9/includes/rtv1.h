...
/*   Updated: 2019/05/10 20:29:13 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
cl_float		ft_rand48(void);
cl_float		ft_clamp(cl_float min, cl_float max, cl_float val);
t_vector	ft_reflect(t_vector i, t_vector n);
int			ft_refract(t_vector i, t_vector n, cl_float eta, t_vector *r);
int			ft_lambertian_sc(t_intersect *in, t_color *att);
int			ft_metal_sc(t_intersect *in, t_color *att);
int			ft_dielectric_sc(t_intersect *in, t_color *att, cl_float ref_idx);
...
t_vector	ft_rotate_x(t_vector r, cl_float angle);
t_vector	ft_rotate_y(t_vector r, cl_float angle);
t_vector	ft_rotate_z(t_vector r, cl_float angle);
...
int			ft_cone_intersect(t_object *s, t_ray *r, cl_float *t);
...
int			ft_cylindre_intersect(t_object *plane, t_ray *r, cl_float *t);
...
t_camera	ft_camera_new(t_vector eye, t_vector look_at, t_vector up, cl_float a);
t_ray		ft_camera_ray(t_camera *cam, cl_float x, cl_float y);
